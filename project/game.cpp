...
void DocCauHoi(string CauHoi[],string DapAnA[],string DapAnB[],string DapAnC[],string DapAnD[],string DapAnDung[]){
	...
	for(int i=0;i<SoCauHoi-(SoCauHoi-1);i++){
		...
		cout<<endl;
		system("canberra-gtk-play -f cau1.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
			//cout<<"=> Do la cau cau tra loi dung !";
			//getline(cin,Enter);
			system("clear");
		}
		else{
	...
	for(int i=1;i<SoCauHoi-(SoCauHoi-2);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau2.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=2;i<SoCauHoi-(SoCauHoi-3);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau3.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=3;i<SoCauHoi-(SoCauHoi-4);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau4.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=4;i<SoCauHoi-(SoCauHoi-5);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau5.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue5.wav");
			//cout<<"=> Do la cau cau tra loi dung !";
			//getline(cin,Enter);
			system("clear");
		}
	...
	for(int i=5;i<SoCauHoi-(SoCauHoi-6);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau6.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=6;i<SoCauHoi-(SoCauHoi-7);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau7.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=7;i<SoCauHoi-(SoCauHoi-8);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau8.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=8;i<SoCauHoi-(SoCauHoi-9);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau9.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=9;i<SoCauHoi-(SoCauHoi-10);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau10.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue10.wav");
			//cout<<"=> Do la cau cau tra loi dung !";
			//getline(cin,Enter);
			system("clear");
		}
	...
	for(int i=10;i<SoCauHoi-(SoCauHoi-11);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau11.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	//Cau 12
	for(int i=11;i<SoCauHoi-(SoCauHoi-12);i++){
		cout<<CauHoi[i]<<endl;
		cout<<endl;
		cout<<DapAnA[i]<<"\t\t\t\t"<<DapAnB[i]<<endl;
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau12.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=12;i<SoCauHoi-(SoCauHoi-13);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau13.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	for(int i=13;i<SoCauHoi-(SoCauHoi-14);i++){
		...
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau14.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue.wav");
	...
	//Cau 15
	for(int i=14;i<SoCauHoi;i++){
		cout<<CauHoi[i]<<endl;
		cout<<endl;
		cout<<DapAnA[i]<<"\t\t\t\t"<<DapAnB[i]<<endl;
		cout<<DapAnC[i]<<"\t\t\t\t"<<DapAnD[i]<<endl;
		cout<<endl;
		system("canberra-gtk-play -f cau15.wav");
		cout<<"=> Cau tra loi cuoi cung cua ban la: ";
		getline(cin,TraLoiCauHoi);
		if(TraLoiCauHoi==DapAnDung[i]){
			system("canberra-gtk-play -f reptrue15.wav");
			getline(cin,Enter);
